...
const mintTree = async (event) => {
  ...
  try {
    ...
    // Show the sharing pop-up card after minting
    showShareModal();
...
// Show the sharing pop-up card
function showShareModal() {
  $('#shareModal').modal('show');
}

// Handle the click event of the "Share Now" button in the pop-up card
document.querySelector('#shareTreeButton').addEventListener('click', () => {
  // Replace the following line with your logic to share the minted tree on social media
  console.log("Sharing the minted tree on social media...");
  // After sharing, close the pop-up card
